...
parser.add_argument('--dataset', default='toys', help='toys')
parser.add_argument('--dataroot', default='toys', help='path to dataset')
...
parser.add_argument('--outf', default='./Mixring3_simPic7', help='folder to output images and model checkpoints')
